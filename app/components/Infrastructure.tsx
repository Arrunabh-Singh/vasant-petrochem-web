...
const Infrastructure = () => {
    return (
        <section id="infrastructure" className="py-32 bg-[#1a4a3a] text-white relative overflow-hidden">
            {/* Abstract Geometry */}
                ...
                <div className="flex flex-col lg:flex-row items-center gap-24">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl font-serif font-bold mb-8 leading-tight">
                            State-of-the-Art <br /><span className="text-[#34d399]">Infrastructure</span>
                        </h2>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-6 border-b border-white/10 pb-6 group">
                                <div className="w-14 h-14 rounded-full bg-[#34d399]/10 flex items-center justify-center shrink-0 border border-[#34d399]/20 group-hover:bg-[#34d399]/20 transition-colors">
