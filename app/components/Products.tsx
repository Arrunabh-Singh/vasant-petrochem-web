    ...
    <section id="products" className="py-24 bg-[#f8fafc]">
      <div className="container-wide">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <Link href="/contact" className="flex items-center gap-2 text-[#246851] font-bold hover:gap-4 transition-all">
        ...
        >
          {products.map((p, idx) => (
            <motion.div
              ...
              className="bg-white rounded-lg glass-card group overflow-hidden"
            >
              {/* Technical Header */}
