...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className={clsx(
        "fixed w-full z-50 transition-shadow duration-300 ease-in-out",
        isScrolled ? "shadow-lg" : "shadow-none",
        "bg-white/80 backdrop-blur-2xl border-b border-[#246851]/10 supports-[backdrop-filter]:bg-white/60"
      )}
    >
      <div className="container-wide">
        ...
        >
          ...
          <div className="flex-shrink-0 flex items-center gap-6 group cursor-pointer">
            <div
              className={clsx(
                "relative transition-all duration-300 ease-in-out group-hover:scale-105",
            ...
            <div className="flex flex-col border-l border-[#246851]/20 pl-6">
              ...
              <span className="text-[11px] font-bold text-[#246851] tracking-[0.3em] uppercase mt-1">
                Petrochem
              </span>
            </div>
          </div>
          ...
          <div className="hidden md:flex space-x-12 items-center">
            ...
            <a
              href="#contact"
              className="btn-primary text-[11px] px-8 py-3 tracking-widest rounded-full"
            >
              GET QUOTE
            </a>
          </div>
      ...
      {isOpen && (
        <motion.div
          ...
          className={clsx(
            "md:hidden absolute left-0 w-full bg-white border-b border-[#246851]/10 p-6 shadow-xl",
...
const Hero = () => {
  ...
  const shapeY = useTransform(scrollYProgress, [0, 1], [0, 150]);

  return (
    <section
      ref={targetRef}
      id="home"
      className="relative min-h-screen flex items-center overflow-hidden bg-[#f8fafc] pt-32 pb-20"
    >
      {/* Brand Pattern Background */}
      <motion.div
        style={{ y: bgY }}
        className="absolute inset-0 bg-grid-pattern opacity-60 z-0"
      />

      {/* Organic Shape Decoration (The 'Drop' from Logo) */}
      <motion.div
        style={{ y: shapeY }}
        className="absolute top-0 right-0 w-[50vw] h-[50vw] bg-[#246851]/5 rounded-bl-full z-0 pointer-events-none blur-3xl"
      />
      ...
      <div className="container-wide relative z-10 flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/80 backdrop-blur-md border border-[#246851]/20 shadow-sm mb-10"
          >
            ...
            <span className="text-[#1a4a3a] font-bold tracking-widest uppercase text-[11px]">
              Industrial Excellence • Est. 2025
            </span>
          </motion.div>

          <motion.h1
            variants={fadeInUp}
            className="h1-hero mb-8 leading-[1.1]"
          >
            Advanced <br />
          ...
          >
            Vasant Petrochem delivers premium industrial solvents and fuels
            engineered for performance. We combine cutting-edge refining
            technology with a robust supply chain to power Central India&apos;s
        ...
        {/* Hero Visual */}
        <motion.div style={{ y }} className="lg:w-1/2 relative">
          <motion.div
            style={{ scale }}
          ...
          >
            ...
            >
              ...
              <p className="text-xs text-slate-500 mt-2 leading-relaxed">
                Exceeding ISO requirements for industrial solvents.
              </p>
            </motion.div>
          </motion.div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((f, idx) => (
            <motion.div
              ...
              className="feature-card group p-8 rounded-2xl bg-[#f8fafc] hover:bg-white border border-transparent hover:border-[#246851]/20 hover:shadow-2xl transition-all duration-500 cursor-default relative overflow-hidden"
            >
...
const InfrastructureSection = () => {
  ...
  return (
    <section
      ref={targetRef}
      className="py-32 bg-[#1a4a3a] text-white relative overflow-hidden"
    >
      {/* Abstract Geometry */}
        ...
        <div className="flex flex-col lg:flex-row items-center gap-24">
          ...
          >
            <div className="inline-block px-4 py-1 border border-white/20 rounded-full bg-white/5 mb-8">
              <span className="text-[#34d399] text-[10px] font-bold tracking-[0.3em] uppercase">
                Global Standards
              </span>
            </div>
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-8 leading-tight">
              State-of-the-Art <br />
              <span className="text-[#34d399]">Infrastructure</span>
            </h2>
            <p className="text-slate-300 text-lg leading-relaxed mb-10 font-light">
              Our Mangaliya facility is engineered for precision and scale. We
              utilize advanced automated blending units and high-capacity
              storage systems to ensure uninterrupted supply for our partners.
              Every operational process is strictly monitored to meet global
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6 border-b border-white/10 pb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm leading-relaxed">
                    Computer-controlled blending ensures consistent viscosity
                    and chemical composition across every batch.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm leading-relaxed">
                    In-house testing facility equipped to verify specific
                    gravity, flash point, and purity in real-time.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative w-full h-full rounded-xl shadow-2xl overflow-hidden z-10">
            ...
            <div className="absolute bottom-10 right-10 bg-black/80 backdrop-blur-xl p-8 rounded-2xl border border-white/10 z-20 w-full max-w-[280px] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
              ...
              <div className="mt-6 pt-4 border-t border-white/5">
                ...
                <p className="text-[9px] text-slate-500 mt-2 text-center uppercase tracking-widest font-mono">
    ...
    >
      <div style={{ transform: "translateZ(20px)" }}>
        ...
        <div className="bg-slate-50 px-6 py-3 border-b border-slate-100 flex justify-between items-center group-hover:bg-[#246851]/5 transition-colors">
          ...
          <span className="font-mono text-xs font-bold text-[#246851]">
            {product.code}
          </span>
        </div>

        <div className="p-8">
          <h3 className="font-bold text-xl text-[#1a4a3a] mb-2">
            {product.name}
          </h3>
  ...
  const products = [
    {
      ...
      code: "IFO-380",
      spec: "Viscosity: 380 cSt",
      desc: "High-grade thermal energy source.",
    },
    {
      name: "Base Oil SN500",
      code: "SN-500",
      spec: "Density: 0.865",
      desc: "Premium lubricant base stock.",
    },
    {
      name: "Paving Bitumen",
      code: "VG-30",
      spec: "Penetration: 60/70",
      desc: "Durable asphalt for infrastructure.",
    },
    {
      name: "Rubber Process Oil",
      code: "RPO-A",
      spec: "Aniline Point: 90°C",
      desc: "Essential for polymer industries.",
    },
    {
      name: "Light Diesel Oil",
      code: "LDO-IN",
      spec: "Flash Point: >66°C",
      desc: "Efficient combustion fuel.",
    },
    {
      name: "Mineral Turpentine",
      code: "MTO",
      spec: "Aromatics: 14%",
      desc: "Versatile industrial solvent.",
    },
  ];
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-slate-600">
              Precision-engineered petrochemicals. Hover over any product for
              specification details.
            </p>
          </div>
          <a
            href="#contact"
            className="flex items-center gap-2 text-[#246851] font-bold hover:gap-4 transition-all"
          >
        ...
        <div className="bg-[#1a4a3a] rounded-3xl p-8 md:p-16 flex flex-col lg:flex-row gap-16 overflow-hidden relative">
          ...
          <div className="lg:w-3/5 relative z-10">
            <motion.form
              ...
              className="space-y-4 bg-white/5 p-8 rounded-2xl border border-white/10 backdrop-blur-sm"
              onSubmit={handleSubmit}
            >
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-xs font-bold text-[#34d399] uppercase tracking-widest">
                    Name
                  </label>
                  <motion.input
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="w-full py-4 bg-[#34d399] text-[#1a4a3a] font-bold rounded-lg hover:bg-white transition-colors"
              >
                SEND MESSAGE
              </motion.button>
              <p className="text-[10px] text-slate-400 text-center mt-4">
                Note: Clicking send will open your default email client (e.g.
                Gmail) to securely transmit your inquiry.
              </p>
            </motion.form>
          </div>
        </div>
